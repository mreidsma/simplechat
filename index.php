...
<?php
			...
			$chitchat = $db->query("SELECT transcript.message_timestamp, transcript.message_id, transcript.message_text, transcript.message_user, users.fname FROM transcript, users WHERE transcript.message_user = users.user_id ORDER BY message_timestamp ASC");
